...
import UHART.Controllers.RegisterController;
...
public class AddPatientFrm {
	...
	public AddPatientFrm(final LoginManager loginManager, final Staff_Model user) {
		...
		allergies.setColumns(10);
                ...
                JButton addMedHist = new JButton("More Medical History");
                addMedHist.addActionListener(new ActionListener() {
                    public void actionPerformed(ActionEvent e)
                    {
                        //registerController.create(contentPane, gl_contentPane);
                    }
                });
				...
				.addGroup(gl_contentPane.createSequentialGroup()
					...
					.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_contentPane.createSequentialGroup()
							...
							.addGap(86)
                                                        .addComponent(addMedHist, GroupLayout.PREFERRED_SIZE, 169, GroupLayout.PREFERRED_SIZE)
							.addGap(86)
		...
		gl_contentPane.setVerticalGroup(
			gl_contentPane.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_contentPane.createSequentialGroup()    
					...
					.addGap(72)
					.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
                                                .addComponent(addMedHist, GroupLayout.PREFERRED_SIZE, 54, GroupLayout.PREFERRED_SIZE)
